...
class InsertDiaryFromImportData
{
     ...
     *
     * @param array<string,array{updated_at:Carbon,created_at:Carbon,user_id:int,uuid:string,date:Carbon,title:string,content:string}> $newDiary insertする日記(重複ないことを確認済みで整形済みのもの)
     */
