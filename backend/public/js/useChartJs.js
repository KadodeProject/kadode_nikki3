...
function updateListeners(chart, state, options) {
  ...
  hooks.forEach(hook => {
    ...
    } else if ((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.defined)(state.listeners[hook])) {
...
function dispatchEvent(handler, element, event) {
  (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.callback)(handler, [element.$context, event]);
}
...
function getNearestItem(elements, position) {
  ...
  return elements
    ...
    .reduce((nearestItems, element) => {
      ...
      const distance = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.distanceBetweenPoints)(position, center);
...
function toPosition(value) {
  if ((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.isObject)(value)) {
    return {
      x: (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.valueOrDefault)(value.x, 'center'),
      y: (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.valueOrDefault)(value.y, 'center'),
    };
  }
  value = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.valueOrDefault)(value, 'center');
  return {
    x: value,
    y: value
  };
...
function measureLabelSize(ctx, options) {
  ...
  const font = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.toFont)(options.font);
...
function drawBox(ctx, rect, options) {
  ...
  (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.addRoundedRectPath)(ctx, {
    ...
    radius: clampAll((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.toTRBLCorners)((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.valueOrDefault)(options.cornerRadius, options.borderRadius)), 0, Math.min(width, height) / 2)
  });
  ctx.closePath();
  ctx.fill();
  if (stroke) {
...
class BoxAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_0__.Element {
  inRange(mouseX, mouseY, useFinalPosition) {
    const {x, y} = rotated({x: mouseX, y: mouseY}, this.getCenterPoint(useFinalPosition), (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.toRadians)(-this.options.rotation));
...
function getPadding(padding, xPadding, yPadding) {
  ...
  return (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.toPadding)(tempPadding);
}
...
function calculateLabelPosition(line, label, sizes, chartArea) {
  ...
  const rotation = label.rotation === 'auto' ? calculateAutoRotation(line) : (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.toRadians)(label.rotation);
...
class EllipseAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_0__.Element {
  ...
  draw(ctx) {
    ...
    ctx.fillStyle = options.backgroundColor;
    const stroke = setBorderStyle(ctx, options);
    ctx.ellipse(center.x, center.y, height / 2, width / 2, chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.PI / 2, 0, 2 * chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.PI);
    ctx.fill();
    if (stroke) {
      ctx.shadowColor = options.borderShadowColor;
      ctx.stroke();
...
class LabelAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_0__.Element {
...
function drawCallout(ctx, element) {
  ...
  const rotatedPoint = rotated({x: pointX, y: pointY}, element.getCenterPoint(), (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.toRadians)(-options.rotation));
...
function resolveCalloutAutoPosition(properties, options, rotation) {
  ...
  for (let index = 0; index < 4; index++) {
    const rotatedPoint = rotated({x: xPoints[index], y: yPoints[index]}, center, (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.toRadians)(rotation));
    result.push({
      position: positions[index],
      distance: (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.distanceBetweenPoints)(rotatedPoint, {x: pointX, y: pointY})
    });
  }
...
class PointAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_0__.Element {
  ...
  draw(ctx) {
    ...
    const stroke = setBorderStyle(ctx, options);
    options.borderWidth = 0;
    (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.drawPoint)(ctx, options, this.x, this.y);
...
class PolygonAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_0__.Element {
  inRange(mouseX, mouseY, useFinalPosition) {
...
function getOrCreateElement(elements, index, type, initProperties) {
  ...
  if (!element || !(element instanceof elementClass)) {
    ...
    if ((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.isObject)(initProperties)) {
...
function resolveObj(resolver, defs) {
  ...
  for (const prop of Object.keys(defs)) {
    ...
    result[prop] = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.isObject)(optDefs) ? resolveObj(value, optDefs) : value;
  }
  return result;
}
...
var annotation = {
  ...
  */
  ...
  afterRegister() {
    ...
    if (!requireVersion('chart.js', '3.7', chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart.version, false)) {
      ...
      chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart.defaults.set('elements.lineAnnotation', {
        callout: {},
        font: {},
        padding: 6
      });
...
function drawSubElements(ctx, elements, caller) {
  for (const el of elements) {
    if ((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_1__.isArray)(el.elements)) {
...
chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart.register(chartjs_plugin_annotation__WEBPACK_IMPORTED_MODULE_1__["default"]);
console.log(chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart);
})();
