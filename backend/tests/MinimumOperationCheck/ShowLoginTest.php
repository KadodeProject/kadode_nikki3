...
final class ShowLoginTest extends TestCase
{
    ...
    public function testログイン済みユーザーならホーム見れる(): void
    {
    ...
    public function testログイン済みユーザーなら日記作成見れる(): void
    {
        $user = User::where('id', 10)->first();
        $response = $this->actingAs($user);
    ...
    public function testログイン済みユーザーならアーカイブ見れる(): void
    {
        $user = User::where('id', 10)->first();
        $response = $this->actingAs($user);
    ...
    public function testログイン済みユーザーなら検索見れる(): void
    {
        $user = User::where('id', 10)->first();
        $response = $this->actingAs($user);
    ...
    public function testログイン済みユーザーなら統計見れる(): void
    {
        $user = User::where('id', 10)->first();
        $response = $this->actingAs($user);
    ...
    public function testログイン済みユーザーなら統計設定見れる(): void
    {
        $user = User::where('id', 10)->first();
        $response = $this->actingAs($user);
    ...
    public function testログイン済みユーザーなら設定見れる(): void
    {
        $user = User::where('id', 10)->first();
        $response = $this->actingAs($user);
    ...
    public function testログイン済みユーザーならセキュリティページで再パスワード要求される(): void
    {
        $user = User::where('id', 10)->first();
        $response = $this->actingAs($user);
     ...
     * 下記より管理者ページ.
     */
    public function test管理ユーザーでなければ管理ページ行けない(): void
    {
        $user = User::where('id', 10)->first();
        $response = $this->actingAs($user);
    ...
    public function test管理ユーザーなら管理ページ行ける(): void
    {
    ...
    public function test管理ユーザーならパッケージ管理ページ行ける(): void
    {
        $user = User::where('id', 1)->first();
        $response = $this->actingAs($user);
    ...
    public function test管理ユーザーなら通知管理ページ行ける(): void
    {
        $user = User::where('id', 1)->first();
        $response = $this->actingAs($user);
    ...
    public function test管理ユーザーならロールとランク管理ページ行ける(): void
    {
        $user = User::where('id', 1)->first();
        $response = $this->actingAs($user);
