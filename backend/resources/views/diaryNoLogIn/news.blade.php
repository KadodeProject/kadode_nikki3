...
<div class="mx-auto px-4" style="max-width: 1200px">
    ...
    ['title'=>'イースターエッグについて',
    'date'=>'2021年10月26日',
    'explain'=>'かどで日記にもイースターエッグを導入しました。ヒントはI`m a "teapot"です。
    '])
    @include('components.noLogIn.news',
    ['title'=>'統計設定ページの追加について',
    'date'=>'2021年10月26日',
    'explain'=>'統計に関する設定は「統計設定」ページから行えます。現在では固有表現ルールの追加と固有表現パッケージの有効無効が可能です
    '])
    @include('components.noLogIn.news',
    ...
    'date'=>'2021年9月16日',
    'explain'=>'より快適なサイト運用を行うため、ログインを伴わないページに限りGoogle Analyticsを導入いたしました。ログイン後のページはGoogle
    Analyticsが作用しませんので、安心してご利用ください。
    '])
    @include('components.noLogIn.news',
