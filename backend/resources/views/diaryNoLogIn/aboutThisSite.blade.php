...
<div class="mx-auto px-4" style="max-width: 1200px">
    ...
    @include('components.noLogIn.explain',
    ['title'=>'JavaScript',
    'explain'=>'本サイトでは、グラフの表示、検索窓などのデザインのためにJavaScript を使用しています。ご使用のブラウザ設定においてJavaScript をオン (有効)
    にされていない場合に、グラフや検索窓が正しく表示されない場合やレイアウトが崩れる場合がありますので、ご了承ください。
    '])

    @include('components.noLogIn.explain',
    ['title'=>'Cookie',
    'explain'=>'本サイトでは、ご利用者様が訪問された際、より快適にご利用いただくため、Cookie を使用しております。Cookie
    ...
    @include('components.noLogIn.explain',
    ['title'=>'技術スタックについて',
    'explain'=>'詳細はGitHubリポジトリをご覧ください→<a
        href="https://github.com/Usuyuki/kadode_nikki3">https://github.com/Usuyuki/kadode_nikki3</a>
    '])
    ...
    '])
    <p class="mb-20"><br><a
            href="https://policies.google.com/technologies/partner-sites?hl=ja">Googleのサービスを使用するサイトやアプリから収集した情報のGoogleによる使用</a>
    </p>
