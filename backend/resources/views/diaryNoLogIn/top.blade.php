...
<div class="board-main py-4 mx-auto" style="max-width: 1200px">
   <div class="mb-4 mt-12">
       <h2 class="text-center text-3xl my-4">かどで日記とは？</h2>
   ...
   <div class="mt-4">
       <h2 class="text-center text-3xl my-4">コンセプト</h2>
       <div class="flex justify-start w-1/2 mx-auto">
           <p class="">人は忘れてしまいます。でも記録は残ります。8世紀に書かれた土佐日記も私達へ受け継がれています。かどで日記の「かどで」は土佐日記に登場する最初の章？「門出」より引用しました。一方で、ページデザインはちょっとSFチックなら色を選びました。近未来っぽさと古代っぽさを掛け合わせたコンセプトです。</p>
       </div>
   </div>
...
<div>
   ...
   <div class="mb-24">
       <h2 class="text-center text-3xl my-4">開発者より</h2>
       <div class="flex justify-start w-1/2 mx-auto">
