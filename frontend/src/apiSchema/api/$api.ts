...
import type { Methods as Methods5 } from './v1/diary';
import type { Methods as Methods6 } from './v1/home';
import type { Methods as Methods7 } from './v1/login/_provider@string';
