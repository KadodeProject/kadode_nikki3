...
import type { Methods as Methods2 } from './v1/home'
import type { Methods as Methods3 } from './v1/login/_provider@string'
import type { Methods as Methods4 } from './v1/osirase/all'
import type { Methods as Methods5 } from './v1/osirase/latest'
import type { Methods as Methods6 } from './v1/releaseNote/all'
import type { Methods as Methods7 } from './v1/releaseNote/latest'
import type { Methods as Methods8 } from './v1/status'
import type { Methods as Methods9 } from './v1/user/init'
