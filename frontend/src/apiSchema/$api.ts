...
import type { Methods as Methods9 } from './api/v1/statistic';
import type { Methods as Methods10 } from './api/v1/status';
import type { Methods as Methods11 } from './api/v1/user/init';
