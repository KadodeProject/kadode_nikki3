<script lang="ts">
	import FormalDocument from '$lib/components/atom/sentence/FormalDocument.svelte';
...
<GuestHead title="利用規約" description="かどで日記の利用規約" />
<PageHeading title="利用規約" />

<div class="document-center">
	<p class="my-4 mb-12">
		この利用規約（以下，「本規約」といいます。）は，うすゆき（以下，「当サービス提供者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
	</p>

	<FormalDocument title="第1条 (適用)">
	...
	<FormalDocument title="第3条（ユーザーIDおよびパスワードの管理）">
		<ol class="list-decimal">
			<li>
				ユーザーは，自己の責任において，本サービスのユーザーIDおよびパスワードを適切に管理するものとします。
			</li>
			<li>
				ユーザーは，自己の責任において，推測されにくい適切なパスワードを作成することとします。なお、サーバー上に保存されたパスワードはハッシュ化されており、適切なパスワードを設定された場合ハッシュ化された文字列からパスワードへの復元は困難となっており、安全性が保たれます。
			</li>
			<li>
	...
	<FormalDocument title="第5条（本サービスの提供の停止等）">
		<ol class="list-decimal">
			<li>
			...
			<li>
				本サービスは個人の趣味によって運用されています。サービス停止の可能性があることを十分ご承知の上、ご利用ください。
			</li>
		</ol>
	</FormalDocument>

	<FormalDocument title="第6条（利用制限および登録抹消）">
		<ol class="list-decimal">
			<li>
	...
	<FormalDocument title="第7条（退会）">
		<p>
			ユーザーは，当サービス提供者の定める退会手続により，本サービスから退会できるものとします。
		</p>
	</FormalDocument>

	<FormalDocument title="第8条（保証の否認および免責事項）">
		<ol class="list-decimal">
			<li>
				当サービス提供者は，本サービスに事実上または法律上の瑕疵（安全性，信頼性，正確性，完全性，有効性，特定の目的への適合性，セキュリティなどに関する欠陥，エラーやバグ，権利侵害などを含みます。）がないことを明示的にも黙示的にも保証しておりません。
			</li>
			<li>
				当サービス提供者は，日記データなどのバックアップを保証しておりません。当サービス提供者の過失でデータが消失した場合であっても保証などは一切致しませんのでユーザー自身で定期的にバックアップをお取りください。バックアップについては設定のエクスポートより日記データを定期的にダウンロードし、ユーザー自身で保管することをおすすめいたします。
			</li>
			<li>
	...
	<FormalDocument title="第13条（準拠法・裁判管轄）">
		<ol class="list-decimal">
